...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_dir", type=str, help="model checkpoints")   #
    parser.add_argument("--load_dir_whole", type=str, help="model checkpoints") #
    parser.add_argument('--load_step', type=int, default=0, help="The checkpoint step to be loaded")
    parser.add_argument("--data_dir", help="The input data") #
    parser.add_argument("--train_set", default="train")
    parser.add_argument("--test_set", default="dev")
    parser.add_argument("--plus_test_set", default="test")
    parser.add_argument("--data_dir_verb", type=str)  #
